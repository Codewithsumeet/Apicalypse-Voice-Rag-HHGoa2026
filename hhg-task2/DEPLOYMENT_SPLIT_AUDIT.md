...
All client-facing assets are located in [`hhg-task2/src/api/static/`](file:///c:/Users/Sumeet/Desktop/HHGOA/hhg-task2/src/api/static/):
...
FastAPI serves the static assets in [`src/api/main.py`](file:///c:/Users/Sumeet/Desktop/HHGOA/hhg-task2/src/api/main.py#L163-L177):
...
All API calls in [`app.js`](file:///c:/Users/Sumeet/Desktop/HHGOA/hhg-task2/src/api/static/app.js) currently use **relative URLs**:
...
- **Entrypoint:** [`src/api/main.py`](file:///c:/Users/Sumeet/Desktop/HHGOA/hhg-task2/src/api/main.py)
- **Router:** Mounted with prefix `/api` in [`src/api/routes.py`](file:///c:/Users/Sumeet/Desktop/HHGOA/hhg-task2/src/api/routes.py)
...
- **Lifespan Handler:** [`src/api/main.py:lifespan()`](file:///c:/Users/Sumeet/Desktop/HHGOA/hhg-task2/src/api/main.py#L120-L151)
...
- **CORS:** Already configured with `allow_origins=["*"]`, `allow_methods=["*"]`, `allow_headers=["*"]` in [`src/api/main.py`](file:///c:/Users/Sumeet/Desktop/HHGOA/hhg-task2/src/api/main.py#L151-L157).
...
1. [`src/api/static/app.js`](file:///c:/Users/Sumeet/Desktop/HHGOA/hhg-task2/src/api/static/app.js):
